...
from reflex_user_portal.backend.api_admin_dashboard.queries import QueryAPI, QueryState
...
def form_item(
    ...
    return rx.accordion.root(
        rx.accordion.item(
            header=rx.text(title, font_size="var(--chakra-fontSizes-sm)"),
            content=rx.vstack(
                rx.box(
...
def form_body_param_item(
    ...
    return rx.accordion.root(
        rx.accordion.item(
            header=rx.text("Body", font_size="var(--chakra-fontSizes-sm)"),
            content=rx.match(
...
def form_request_item():
    return rx.accordion.root(
        rx.accordion.item(
            header=rx.text("Requests", font_size="var(--chakra-fontSizes-sm)"),
            content=rx.hstack(
                rx.select(
